...
export const DEPARTMENTS = [
  { id: 1, name: "Human Resources",      head: "HR Manager",          staffCount: 5,  color: "#7c3aed", icon: "👥" },
  { id: 2, name: "Internal Medicine",    head: "Dr. Emily Chen",      staffCount: 24, color: "#2563eb", icon: "🫀" },
  { id: 3, name: "Front Office",         head: "Supervisor",          staffCount: 8,  color: "#14b8a6", icon: "🏥" },
  { id: 4, name: "Pediatrics",           head: "Dr. Aisha Patel",     staffCount: 15, color: "#16a34a", icon: "👶" },
  { id: 5, name: "Emergency Medicine",   head: "Dr. Marcus Webb",     staffCount: 18, color: "#dc2626", icon: "🚨" },
  { id: 6, name: "Surgery",              head: "Dr. Robert Kim",      staffCount: 20, color: "#ea580c", icon: "🔬" },
  { id: 7, name: "Cardiology",           head: "Dr. Fatima Hassan",   staffCount: 14, color: "#0891b2", icon: "💓" },
  { id: 8, name: "Neurology",            head: "Dr. James Osei",      staffCount: 11, color: "#7c3aed", icon: "🧠" },
  { id: 9, name: "Radiology",            head: "Dr. Lin Zhao",        staffCount: 10, color: "#9333ea", icon: "🩻" },
  { id: 10, name: "Pharmacy",            head: "Head Pharmacist",     staffCount: 8,  color: "#059669", icon: "💊" },
  { id: 11, name: "Patient Services",    head: "Service Manager",     staffCount: 6,  color: "#0d9488", icon: "🎧" },
];
